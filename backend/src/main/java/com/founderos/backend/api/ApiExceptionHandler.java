...
import com.founderos.backend.client.OrchestratorClient.OrchestratorException; import com.founderos.backend.service.*; import com.founderos.backend.slack.SlackSecurityException; import org.springframework.http.*; import org.springframework.web.bind.MethodArgumentNotValidException; import org.springframework.web.bind.annotation.*; import java.net.URI;
...
public class ApiExceptionHandler {
 ...
 @ExceptionHandler(SlackSecurityException.class) ProblemDetail unauthorized(SlackSecurityException e){return problem(HttpStatus.UNAUTHORIZED,"Unauthorized Slack request",e.getMessage());}
